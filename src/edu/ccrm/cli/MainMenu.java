...
/**
 * Main CLI interface for the CCRM application. Provides a text-based menu
 * system for managing students, courses, enrollments, and reports.
 *
...
public class MainMenu {
    ...
    /**
     * Loads sample data from CSV files for demonstration.
     */
    private void loadSampleData() {
        ...
        try {
            ...
            System.out.println("Warning: Could not load sample data: " + e.getMessage());
        }
    }
        ...
        switch (choice) {
            ...
            case "2" -> {
                try {
                    ...
                    System.out.println("Invalid credits. Please enter a number.");
                } catch (Exception e) {
        ...
        switch (scanner.nextLine()) {
            ...
            case "2" -> {
                ...
                try {
                    ...
                    if (choice == 0) {
                        // Back
                    } else if (choice > 0 && choice <= ungradedEnrollments.size()) {
    ...
    private void manageImportExport() {
        ...
        switch (scanner.nextLine()) {
            case "1" -> {
                try {
                    ioService.exportStudents(studentService);
                } catch (Exception e) {
            ...
            case "2" -> {
                try {
                    ioService.exportCourses(courseService);
                } catch (Exception e) {
                    System.out.println("Error: " + e.getMessage());
                }
            }
